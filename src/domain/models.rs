...
//! | Type         | Description                                          |
//! | ------------ | ---------------------------------------------------- |
//! | [`User`]     | Registered account with a role and hashed password   |
//! | [`Room`]     | Chat room, either direct (1:1) or group              |
//! | [`RoomUser`] | Membership record linking a user to a room           |
//! | [`Message`]  | A single chat message inside a room                  |
//!
//! ## Conventions
//!
//! - All primary keys are [`uuid::Uuid`] values generated with
//!   [`Uuid::now_v7`] (time-ordered UUIDv7).
...
/// Membership record that links a [`User`] to a [`Room`].
///
